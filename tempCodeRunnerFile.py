...
class FlagQuizScreen(BoxLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.score = 0
        self.time_left = 20  # Αρχικός χρόνος ανά ερώτηση σε δευτερόλεπτα
    ...
    def start_game(self, instance):
        ...
        self.user_guess = TextInput(hint_text='Enter country name', multiline=False, size_hint=(None, None), width=200, height=40, pos_hint={'right': 0.63})
    ...
    def update_flag_and_score(self):
        ...
        self.time_left = 20  # Επαναφορά χρόνου ανά ερώτηση σε 10 δευτερόλεπτα
    ...
    def check_answer(self, instance):
        ...
        if user_guess == correct_country.lower():
            self.score += 1
            self.score_label.text = f'Score: {self.score}'  # Ενημέρωση ετικέτας βαθμολογίας
            ...
            self.score_label.text = 'Error'  # Εμφάνιση "Error" για λανθασμένη απάντηση
